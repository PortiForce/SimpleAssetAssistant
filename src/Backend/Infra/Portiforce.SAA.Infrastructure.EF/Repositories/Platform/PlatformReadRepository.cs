...
internal sealed class PlatformReadRepository : IPlatformReadRepository
{
	...
	public Task<bool> ExistsByNameAsync(string name, CancellationToken ct) => throw new NotImplementedException();

	public Task<PagedResult<PlatformListItem>> GetListByTenantIdAsync(
		TenantId tenantId,
