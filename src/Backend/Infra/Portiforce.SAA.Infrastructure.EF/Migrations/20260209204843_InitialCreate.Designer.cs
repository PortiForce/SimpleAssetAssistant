...
namespace Portiforce.SAA.Infrastructure.EF.Migrations
{
    ...
    [Migration("20260209204843_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portiforce.SAA.Core.Assets.Models.Asset", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Portiforce.SAA.Core.Assets.Models.Platform", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Portiforce.SAA.Core.Assets.Models.PlatformAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Portiforce.SAA.Core.Identity.Models.Auth.ExternalIdentity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Portiforce.SAA.Core.Identity.Models.Auth.PasskeyCredential", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Portiforce.SAA.Core.Identity.Models.Client.Tenant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Settings", "Portiforce.SAA.Core.Identity.Models.Client.Tenant.Settings#TenantSettings", b1 =>
                        {
                            b1.IsRequired();

                            b1.ComplexProperty(typeof(Dictionary<string, object>), "Defaults", "Portiforce.SAA.Core.Identity.Models.Client.Tenant.Settings#TenantSettings.Defaults#TenantDefaults", b2 =>
                                {
                                    b2.IsRequired();
                            ...
                            b1.ComplexProperty(typeof(Dictionary<string, object>), "Import", "Portiforce.SAA.Core.Identity.Models.Client.Tenant.Settings#TenantSettings.Import#TenantImportSettings", b2 =>
                                {
                                    b2.IsRequired();
                            ...
                            b1.ComplexProperty(typeof(Dictionary<string, object>), "Retention", "Portiforce.SAA.Core.Identity.Models.Client.Tenant.Settings#TenantSettings.Retention#TenantRetentionSettings", b2 =>
                                {
                                    b2.IsRequired();
                            ...
                            b1.ComplexProperty(typeof(Dictionary<string, object>), "Security", "Portiforce.SAA.Core.Identity.Models.Client.Tenant.Settings#TenantSettings.Security#TenantSecuritySettings", b2 =>
                                {
                                    b2.IsRequired();
            ...
            modelBuilder.Entity("Portiforce.SAA.Core.Identity.Models.Client.TenantRestrictedAsset", b =>
                {
                    b.Property<Guid>("TenantId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Portiforce.SAA.Core.Identity.Models.Client.TenantRestrictedPlatform", b =>
                {
                    b.Property<Guid>("TenantId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Portiforce.SAA.Core.Identity.Models.Profile.Account", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Contact", "Portiforce.SAA.Core.Identity.Models.Profile.Account.Contact#ContactInfo", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Settings", "Portiforce.SAA.Core.Identity.Models.Profile.Account.Settings#AccountSettings", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Portiforce.SAA.Core.Activities.Models.Legs.AssetMovementLeg", b =>
                {
                    ...
                    b.HasOne("Portiforce.SAA.Core.Assets.Models.Asset", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Portiforce.SAA.Core.Assets.Models.PlatformAccount", b =>
                {
                    ...
                    b.HasOne("Portiforce.SAA.Core.Assets.Models.Platform", null)
                        .WithMany()
