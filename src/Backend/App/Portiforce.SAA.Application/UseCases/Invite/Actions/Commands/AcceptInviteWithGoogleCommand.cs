...
/// </summary>
/// <remarks>
///     Use this command when a user is invited to join a tenant via Google authentication. All parameters
///     are required to process the acceptance and establish the user's identity within the system.
/// </remarks>
...
/// <param name="Verified">Determines if provided email was verified or not.</param>
public sealed record AcceptInviteWithGoogleCommand(
	...
	string FirstName,
	string LastName,
	bool Verified) : ICommand<TypedResult<AcceptInviteResult>>;