...
) : IRequestHandler<RegisterExchangeCommand, TypedResult<ActivityId>>
{
	public async ValueTask<TypedResult<ActivityId>> Handle(RegisterExchangeCommand request, CancellationToken ct)
	{
