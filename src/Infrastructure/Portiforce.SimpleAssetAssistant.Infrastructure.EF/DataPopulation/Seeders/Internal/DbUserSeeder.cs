...
namespace Portiforce.SimpleAssetAssistant.Infrastructure.EF.DataPopulation.Seeders.Internal;

public class DbUserSeeder(
	AssetAssistantDbContext dbContext,
	IOptions<PlatformUsersSettings> platformUsersOptions,
	ILogger<DbUserSeeder> logger)
{
	private readonly PlatformUsersSettings _config = platformUsersOptions.Value;
